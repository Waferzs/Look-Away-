#include <iostream>
#include <chrono> //Timer based executions
#include <thread> //helps with making the code sleep
#include <ctime>
#include <cstdlib>

#ifdef _WIN32 //Had some difficulties with different OS's so this was a fix
#include <windows.h>
#include <conio.h>
#else
#include <ncurses.h>
...
cout << "--------------------------\n"; // Add a newline character here
        ...
        //Sleep for making the code wait until next output and chrono for the unit of time
